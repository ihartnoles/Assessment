<div id="pjax">
...
</div><!-- #topbar -->			<div id="sidebar" class="sidebar pjax_links fixed">
	<div class="cog">+</div>
	...
	<ul class="side_accordion" id="nav_side"> <!-- add class 'open_multiple' to change to from accordion to toggles -->
		<li class="icon_only"><a href="index.php" class="pjax"><img src="images/icons/small/grey/laptop.png"/><span>Home</span></a></li>
		...
		<li><a href="#"><img src="images/icons/small/grey/frames.png"/><span>Layout</span></a>
			<ul class="drawer">
				...
				<li><a class="hide_mobile" href="#"><span>Layout Width</span></a></li>
				<li><a class="hide_mobile" href="#"><span>Layout Position</span></a></li>
				<li><a class="hide_mobile" href="#"><span>Isolated Layout</span><div class="alert badge">&#9733</div></a></li>
			</ul>
		</li>
		...
		<li><a href="#"><img src="images/icons/small/grey/create_write.png"/><span>Forms</span></a>
			<ul class="drawer">
				...
				<li><a href="#"><span>Example Forms</span><div class="alert badge">&#9733</div></a></li>
			</ul>
		</li>
		...
		<li><a href="#"><img src="images/icons/small/grey/file_cabinet.png"/><span>Org</span><div class="alert badge">1</div></a>
			<ul class="drawer">
				<li><a href="files.php" class="pjax"><img src="images/icons/small/white/folder.png"/><span>Files</span></a></li>
				<li><a href="contacts.php" class="pjax"><img src="images/icons/small/white/users.png"/><span>Contacts</span><div class="alert badge alert_orange">&#9733</div></a></li>
			</ul>
		</li>
		<li><a href="calendar.php" class="pjax"><img src="images/icons/small/grey/month_calendar.png"/><span>Cal</span></a></li>
		<li><a href="charts.php" class="pjax"><img src="images/icons/small/grey/graph.png"/><span>Charts</span><div class="alert badge alert_black">1</div></a>
			<ul class="drawer">
				<li><a href="charts.php" class="pjax"><span>Large Charts</span></a></li>
				<li><a href="graphs.php" class="pjax"><span>Info Graphs</span></a><div class="alert badge alert_blue">new</div></li>
			</ul></li>
		<li class="icon_only"><a href="#"><img src="images/icons/small/grey/locked_2.png"/><span>Login</span><div class="alert badge alert_red">1</div></a>
			<ul class="drawer">
				<li><a href="login_button.php" class="pjax"><span>Regular Login</span></a></li>
				<li><a href="#" class="dialog_button" data-dialog="dialog_logout"><span>Slide Login</span><div class="alert badge alert_magenta">cool</div></a></li>
			</ul>
		</li>
	</ul>
