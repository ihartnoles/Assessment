							...
							<div class="box-content">
								...
								<div class="row-fluid">
									...
									<div class="box-content">
										...
										<div class="row-fluid">
											...
											<textarea id="CommentsInstruction" name="CommentsInstruction" class="input-block-level">#qReviewDetails.commentsinstruction#</textarea>
										</div>
								...
								<div class="row-fluid">
									...
									<div class="box-content">
										...
										<div class="row-fluid">
											<textarea id="CommentsResearch" name="CommentsResearch" class="input-block-level">#qReviewDetails.commentsresearch#</textarea>
										</div>
								...
								<div class="row-fluid">
									...
									<div class="box-content">
										...
										<div class="row-fluid">
											<textarea id="CommentsService" name="CommentsService" class="input-block-level">#qReviewDetails.commentsservice#</textarea>
										</div>
								...
								<div class="row-fluid">
									...
									<div class="box-content">
										...
										<div class="row-fluid">
											<textarea id="SummaryComments" name="SummaryComments" class="input-block-level">#qReviewDetails.SummaryComments#</textarea>
										</div>
										...
										<div class="row-fluid">
											<textarea id="NewInitiatives" name="NewInitiatives" class="input-block-level">#qReviewDetails.NewInitiatives#</textarea>
										</div>
